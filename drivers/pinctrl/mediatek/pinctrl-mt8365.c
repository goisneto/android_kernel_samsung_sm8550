...
static const struct mtk_pin_drv_grp mt8365_pin_drv[] = {
	...
	MTK_PIN_DRV_GRP(0, 0x910, 0, 2),
	MTK_PIN_DRV_GRP(1, 0x910, 0, 2),
	MTK_PIN_DRV_GRP(2, 0x910, 0, 2),
	MTK_PIN_DRV_GRP(3, 0x910, 0, 2),
	MTK_PIN_DRV_GRP(4, 0x910, 4, 2),
	MTK_PIN_DRV_GRP(5, 0x910, 4, 2),
	MTK_PIN_DRV_GRP(6, 0x910, 4, 2),
	MTK_PIN_DRV_GRP(7, 0x910, 4, 2),
	MTK_PIN_DRV_GRP(8, 0x910, 8, 2),
	MTK_PIN_DRV_GRP(9, 0x910, 8, 2),
	MTK_PIN_DRV_GRP(10, 0x910, 8, 2),
	MTK_PIN_DRV_GRP(11, 0x910, 8, 2),
	MTK_PIN_DRV_GRP(12, 0x910, 12, 2),
	MTK_PIN_DRV_GRP(13, 0x910, 12, 2),
	MTK_PIN_DRV_GRP(14, 0x910, 12, 2),
	MTK_PIN_DRV_GRP(15, 0x910, 12, 2),
	MTK_PIN_DRV_GRP(16, 0x910, 16, 2),
	MTK_PIN_DRV_GRP(17, 0x910, 16, 2),
	MTK_PIN_DRV_GRP(18, 0x910, 16, 2),
	MTK_PIN_DRV_GRP(19, 0x910, 20, 2),
	MTK_PIN_DRV_GRP(20, 0x910, 24, 2),
	MTK_PIN_DRV_GRP(21, 0x910, 24, 2),
	MTK_PIN_DRV_GRP(22, 0x910, 28, 2),
