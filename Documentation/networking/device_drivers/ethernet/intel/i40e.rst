 ...
 * Intel(R) Ethernet Controller X910
...
---------------------------
Some adapters based on the Intel Ethernet Controller X910/XL710 support
...
NOTE: X910/XXV710 devices fail to enable Max VFs (64) when Multiple Functions
